    ...
    <div className="">
      ...
      <div className="flex justify-between gap-3">
        <button
          ...
          className="w-full bg-neutral-900 font-semibold p-2 py-3 rounded-lg text-white text-xl"
        >
          Accept
        </button>
        <button
          ...
          className="w-full bg-neutral-500 font-semibold p-2  py-3 rounded-lg text-white text-xl"
        >
          Ignore
        </button>
      </div>
